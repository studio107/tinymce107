...
(function() {
	...
	tinymce.create('tinymce.plugins.ImagesUsersPlugin', {
		init : function(ed, url) {
			// Register commands
			ed.addCommand('mceImagesUsers', function() {
	...
	// Register plugin
	tinymce.PluginManager.add('images_users', tinymce.plugins.ImagesPlugin);
})();